<template>
	<view>
		<view :class="[{ header_fixed: navFixed, header_absolute: type == 'transparent', header_shadow: navShadow, header_colorWhite: isWhite }, themeBgColorName]"
			...
			<view class="header_content">
				<view class="header_left_box">
					<slot name="transparentFixedLeft">
						<view class="header_left_info header_transparentFixed_left_info" :class="{ header_transparentFixed_colorWhite_left_info: isWhite }" v-if="back || $slots.left || home">
							<view class="header_left_back" :class="{ header_btnMongol_left_back: isTwoBtn }" v-if="back && !firstPage" @click="onBackPage">
								<image class="header_icon" v-if="isWhite" src="/static/zhouWei-navBar/icon_back_white.png" mode="aspectFit"></image>
								<image class="header_icon" v-else src="/static/zhouWei-navBar/icon_back_black.png" mode="aspectFit"></image>
							</view>
...
<script>
	...
	const mainPagePath = ['pages/myUni/home', 'pages/myUni/my', 'pages/demo/common', 'pages/template/common', 'pages/apiDemo/common'];
	//返回首页的地址
